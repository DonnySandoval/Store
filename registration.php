                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <input class="form-control" type="text" required name="clien-nit" title="Ingrese su número de DNI. Solamente números" maxlength="15">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input class="form-control" type="tel" required name="clien-phone" maxlength="15" title="Ingrese su número telefónico. Mínimo 8 dígitos máximo 15">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group label-floating">
...
<input class="form-control" type="text" required name="clien-dir" title="Ingrese la dirección en la que reside actualmente" maxlength="100">
</div>
</div>
<div class="col-xs-12">
...
<input class="form-control" type="text" required name="clien-name" title="Ingrese su nombre. Máximo 9 caracteres (solamente letras y números sin espacios)" pattern="[a-zA-Z0-9]{1,9}" maxlength="9">
</div>
</div>
<div class="col-xs-12 col-sm-6">
<div class="form-group label-floating">
