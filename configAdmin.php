...
<body id="container-page-configAdmin">
    ...
    $newOrders = ejecutarSQL::consultar("SELECT COUNT(*) AS Total FROM venta WHERE Estado='Pendiente'");
    $totalNewOrders = mysqli_fetch_assoc($newOrders)['Total'];
    ?>
            ...
            <li>
              <a href="configAdmin.php?view=order">
                ...
                <?php if ($totalNewOrders > 0) : ?>
                  <span class="badge badge-danger"><?php echo $totalNewOrders; ?></span>
                <?php endif; ?>
              </a>
            </li>
            <li>
