...
<body id="container-page-product">
       ...
       <br>
        <div class="container">
            ...
            ?>
              <div class="row">
                <?php
                  // Resto del código para mostrar productos de una categoría específica
            ...
            ?>
              <div class="row">
                ...
                ?>
                    ...
                    <button class="btn btn-success btn-sm btn-raised btn-block btn-add-to-cart" data-codigo="<?php echo $prod['CodigoProd']; ?>"><i class="fa fa-cart-plus"></i>&nbsp; Agregar al carrito</button>
                <?php endif; ?>
                                </p>
    ...
    <?php
        ...
        $consultar_productos = mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM producto WHERE Stock > 0 AND Estado='Activo' ORDER BY NombreProd ASC LIMIT $inicio, $regpagina");
    ...
    ?>
                <div class="col-xs-12 col-sm-6 col-md-4">
                     <div class="thumbnail rounded">
                       <img class="img-product rounded" src="./assets/img-products/<?php if($prod['Imagen'] != "" && is_file("./assets/img-products/".$prod['Imagen'])){ echo $prod['Imagen']; } else { echo "default.png"; } ?>">
                       <div class="caption">
                         <h3><?php echo $prod['Marca']; ?></h3>
                         <p><?php echo $prod['NombreProd']; ?></p>
                         <?php if($prod['Descuento'] > 0): ?>
    ...
    ?>
        ...
        <div class="text-center">
          <ul class="pagination">
            ...
            <?php else: ?>
                <li>
                    <a href="product.php?pag=<?php echo $pagina-1; ?>">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
            <?php endif; ?>
            ...
            <?php
                for($i = 1; $i <= $numeropaginas; $i++) {
                    if($pagina == $i) {
                        echo '<li class="active"><a href="product.php?pag='.$i.'">'.$i.'</a></li>';
                    } else {
                        echo '<li><a href="product.php?pag='.$i.'">'.$i.'</a></li>';
                    }
                }
            ?>
